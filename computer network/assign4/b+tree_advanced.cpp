...
void insert(struct bpnode* t1,struct bnode*& t,struct bnode*& p,int key)
{if(t==NULL)
{cout<<"sexy;;;;;;";
  t=new bnode();
t->key[0]=key;
...
insert(root,parent,101);
insert(root,parent,121);
insert(root,parent,131);

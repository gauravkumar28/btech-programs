...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fstanford-cs193g-sp2010%2Fsource%2Fbrowse%2Ftrunk%2Ftutorials%2Futil%2FcuPrintf.cuh" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/stanford-cs193g-sp2010/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/stanford-cs193g-sp2010/source/browse/trunk/tutorials/">tutorials</a><span class="sp">/&nbsp;</span><a href="/p/stanford-cs193g-sp2010/source/browse/trunk/tutorials/util/">util</a><span class="sp">/&nbsp;</span>cuPrintf.cuh</span>
 ...
 <a href="/p/stanford-cs193g-sp2010/source/browse/trunk/tutorials/util/cuPrintf.cuh?edit=1"
...
><td class="source">#ifndef CUPRINTF_H<br></td></tr
><tr
id=sl_svn285_45

><td class="source">#define CUPRINTF_H<br></td></tr
><tr
id=sl_svn285_46
...
><td class="source"> *	This is the header file supporting cuPrintf.cu and defining both<br></td></tr
><tr
id=sl_svn285_49

><td class="source"> *	the host and device-side interfaces. See that file for some more<br></td></tr
><tr
id=sl_svn285_50

><td class="source"> *	explanation and sample use code. See also below for details of the<br></td></tr
><tr
id=sl_svn285_51

><td class="source"> *	host-side interfaces.<br></td></tr
><tr
id=sl_svn285_52
...
><td class="source"> *  Quick sample code:<br></td></tr
><tr
id=sl_svn285_54
...
><td class="source">// DEVICE SIDE<br></td></tr
><tr
id=sl_svn285_74

><td class="source">// External function definitions for device-side code<br></td></tr
><tr
id=sl_svn285_75
...
><td class="source">// Abuse of templates to simulate varargs<br></td></tr
><tr
id=sl_svn285_77
...
><td class="source">//	Called to restrict output to a given thread/block. Pass<br></td></tr
><tr
id=sl_svn285_94

><td class="source">//	the constant CUPRINTF_UNRESTRICTED to unrestrict output<br></td></tr
><tr
id=sl_svn285_95

><td class="source">//	for thread/block IDs. Note you can therefore allow<br></td></tr
><tr
id=sl_svn285_96

><td class="source">//	&quot;all printfs from block 3&quot; or &quot;printfs from thread 2<br></td></tr
><tr
id=sl_svn285_97

><td class="source">//	on all blocks&quot;, or &quot;printfs only from block 1, thread 5&quot;.<br></td></tr
><tr
id=sl_svn285_98
...
><td class="source">//		threadid - Thread ID to allow printfs from<br></td></tr
><tr
id=sl_svn285_101

><td class="source">//		blockid - Block ID to allow printfs from<br></td></tr
><tr
id=sl_svn285_102
...
><td class="source">//	NOTE: Restrictions last between invocations of<br></td></tr
><tr
id=sl_svn285_104

><td class="source">//	kernels unless cudaPrintfInit() is called again.<br></td></tr
><tr
id=sl_svn285_105
...
><td class="source">#define CUPRINTF_UNRESTRICTED	-1<br></td></tr
><tr
id=sl_svn285_107
...
><td class="source">// External function definitions for host-side code<br></td></tr
><tr
id=sl_svn285_114
...
><td class="source">//	Call this once to initialise the printf system. If the output<br></td></tr
><tr
id=sl_svn285_119

><td class="source">//	file or buffer size needs to be changed, call cudaPrintfEnd()<br></td></tr
><tr
id=sl_svn285_120

><td class="source">//	before re-calling cudaPrintfInit().<br></td></tr
><tr
id=sl_svn285_121
...
><td class="source">//	The default size for the buffer is 1 megabyte. For CUDA<br></td></tr
><tr
id=sl_svn285_123

><td class="source">//	architecture 1.1 and above, the buffer is filled linearly and<br></td></tr
><tr
id=sl_svn285_124

><td class="source">//	is completely used;	however for architecture 1.0, the buffer<br></td></tr
><tr
id=sl_svn285_125

><td class="source">//	is divided into as many segments are there are threads, even<br></td></tr
><tr
id=sl_svn285_126

><td class="source">//	if some threads do not call cuPrintf().<br></td></tr
><tr
id=sl_svn285_127
...
><td class="source">//		bufferLen - Length, in bytes, of total space to reserve<br></td></tr
><tr
id=sl_svn285_130

><td class="source">//		            (in device global memory) for output.<br></td></tr
><tr
id=sl_svn285_131
...
><td class="source">//		cudaSuccess if all is well.<br></td></tr
><tr
id=sl_svn285_134
...
><td class="source">extern &quot;C&quot; cudaError_t cudaPrintfInit(size_t bufferLen=1048576);   // 1-meg - that&#39;s enough for 4096 printfs by all threads put together<br></td></tr
><tr
id=sl_svn285_136
...
><td class="source">//	Cleans up all memories allocated by cudaPrintfInit().<br></td></tr
><tr
id=sl_svn285_141

><td class="source">//	Call this at exit, or before calling cudaPrintfInit() again.<br></td></tr
><tr
id=sl_svn285_142
...
><td class="source">//	Dumps the contents of the output buffer to the specified<br></td></tr
><tr
id=sl_svn285_149

><td class="source">//	file pointer. If the output pointer is not specified,<br></td></tr
><tr
id=sl_svn285_150

><td class="source">//	the default &quot;stdout&quot; is used.<br></td></tr
><tr
id=sl_svn285_151
...
><td class="source">//		outputFP     - A file pointer to an output stream.<br></td></tr
><tr
id=sl_svn285_154

><td class="source">//		showThreadID - If &quot;true&quot;, output strings are prefixed<br></td></tr
><tr
id=sl_svn285_155

><td class="source">//		               by &quot;[blockid, threadid] &quot; at output.<br></td></tr
><tr
id=sl_svn285_156
...
><td class="source">extern &quot;C&quot; cudaError_t cudaPrintfDisplay(void *outputFP=NULL, bool showThreadID=false);<br></td></tr
><tr
id=sl_svn285_161
...
><td class="source">#endif  // CUPRINTF_H<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 by jaredhoberock
 on Mar 9, 2010
 &nbsp; <a href="/p/stanford-cs193g-sp2010/source/diff?spec=svn285&r=8&amp;format=side&amp;path=/trunk/tutorials/util/cuPrintf.cuh&amp;old_path=/trunk/tutorials/util/cuPrintf.cuh&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/tutorials/util/cuPrintf.cuh';
 ...
 <a href="/p/stanford-cs193g-sp2010/source/list?path=/trunk/tutorials/util/cuPrintf.cuh&start=8">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//stanford-cs193g-sp2010.googlecode.com/svn/trunk/tutorials/util/cuPrintf.cuh">View raw file</a></div>
 </div>

...
printf("%d ",bufferC[i*4+j]);
        ...
        cblas_dgemm (CblasColMajor, CblasNoTrans, CblasTrans, 4, 4 , nRows, alpha, bufferA, nRows , bufferB , 4, beta, bufferC, 4);
        ...
        /* Compute Gflops */
         Gflops= ( 1.0e-3 * (1.0e-6 * ((2. * 4 *nRows * 4) /Tsec_cpu))) ;
